public class MManusia {
    public static void main(String[] args) {
        ...
        System.out.println("Pajak PNS p1 = " + IdFormatter.getCurrencyIdFormat(p1.hitungPajak()));
        System.out.println("Pajak Pengusaha pe1 = " + IdFormatter.getCurrencyIdFormat(pe1.hitungPajak()));
        System.out.println("Pajak Petani pt1 = " + IdFormatter.getCurrencyIdFormat(pt1.hitungPajak()));
